...
router.get('/getTopGames', async (req, res) => {
...
router.get('/get_player_toatlscore/', authenticateToken, async (req, res) => {
...
router.get('/get_player_username', authenticateToken, async (req, res) => {
    const username = req.user.email;
